# 🖥️ Инфраструктура Л.Е.С. v2.0+ (Mac Mini M4 + Docker + MLX)

**Статус:** ✅ Активна | **Обновлено:** 22.05.2026 | **Версия:** 3.3 runtime
**Архитектура:** Headless Mac Mini M4 / 24 GB + ZeroTier P2P + Docker (Qdrant + Proxy) + MLX Native Host. Ollama сохранён как резерв.
