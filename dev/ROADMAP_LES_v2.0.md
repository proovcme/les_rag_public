...
- **RAG modernization plan (историческое):** прежний план перенесён в `docs/archive/root-legacy/RAG_MODERNIZATION_PLAN.md`; текущий контракт retrieval находится в `docs/ALGO-rag-best-practices.md` и корневом `ROADMAP_TO_V1.md`.
