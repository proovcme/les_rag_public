...
MODE_PROMPTS: dict[str, str] = {
    ...
    "smeta": (
        ...
        "а не гадание на бетоне. В чате дай короткую сводку, подробную простыню — в артефакт."
    ),
    "smeta_harness": (
    ...
    "review": (
        ...
        "риски, затем вопросы, потом краткий итог. Не украшай пустоту: если файл виден, но в нём нет "
