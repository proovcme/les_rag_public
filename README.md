...
![LES](https://img.shields.io/badge/LES-0.24.0.0-0b8f64)
...
Текущий публичный кандидат: **0.24.0.0** — SPДС-нормоконтроль по ГОСТ Р 21.101-2026,
служебные источники данных для смет/нормоконтроля и проверяемые отчёты JSON/HTML/XLSX.
