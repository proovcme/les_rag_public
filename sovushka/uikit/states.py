"""Pure UI-state mapping used by chat, evidence, and document surfaces."""
...
def feedback_state(
    ...
    *,
    ...
    presets = {
        ...
        "error": ("Не удалось выполнить действие", "Повторите попытку или откройте технические детали."),
        "blocked": (
            "Поиск по источникам недоступен",
            "Ответ не сформирован, чтобы не подменять выбранные документы данными из другого корпуса.",
        ),
    }
