...
_RIM_PUBLIC_CSS = """
<style id="sovushka-rim-public">
.sov-ui-panel{width:100%;padding:16px;border:1px solid var(--border);
  border-radius:8px;background:var(--bg-panel)}
.sov-ui-panel--raised{box-shadow:0 5px 16px rgba(20,52,34,.05)}
.sov-ui-section-heading{gap:4px!important}
.sov-ui-section-title{font-size:14px;font-weight:750;color:var(--text)}
.sov-ui-section-detail{font-size:12px;color:var(--dim);max-width:780px}
.sov-ui-button{min-height:38px;border:1px solid var(--border);
  border-radius:8px;padding:0 12px;color:var(--text)}
.sov-ui-button--primary{background:var(--accent)!important;
  border-color:var(--accent)!important;color:white!important}
.sov-ui-button--quiet{border-color:transparent;color:var(--dim)}
.sov-ui-button--danger{color:var(--err);border-color:var(--err)}
.sov-ui-button--compact{min-height:32px;padding:0 9px}
.sov-ui-input .q-field__control,.sov-ui-select .q-field__control{
  min-height:40px;border-radius:8px}
.sov-ui-status{padding:4px 8px;border:1px solid currentColor;border-radius:999px;
  font-size:11px;font-weight:700}
.sov-ui-status--ok{color:var(--ok)}.sov-ui-status--warn{color:var(--warn)}
.sov-ui-status--error,.sov-ui-status--blocked{color:var(--err)}
.sov-ui-status--muted{color:var(--dim)}
.sov-ui-feedback{padding:12px;border-left:3px solid var(--border);
  background:var(--bg-mod);border-radius:6px}
.sov-ui-feedback--error,.sov-ui-feedback--blocked{border-left-color:var(--err)}
.sov-ui-feedback__title{font-weight:800}.sov-ui-feedback__detail{font-size:12px;color:var(--dim)}
.sov-rim-page{max-width:1500px;margin:0 auto;padding:18px;gap:14px!important}
.sov-rim-hero__head,.sov-rim-dialog__head,.sov-rim-status-strip,
.sov-rim-composer,.sov-rim-actions{width:100%;align-items:center;
  justify-content:space-between;gap:10px;flex-wrap:wrap}
.sov-rim-hero__actions,.sov-rim-status-strip__badges,
.sov-rim-question__choices{gap:8px;flex-wrap:wrap}
.sov-rim-session-select{min-width:280px}
.sov-rim-status-strip__meta,.sov-rim-panel-summary,.sov-rim-intake__status{
  color:var(--dim);font-size:12px}
.sov-rim-intake,.sov-rim-dialog,.sov-rim-workspace{gap:14px!important}
.sov-rim-intake__fields{display:grid!important;grid-template-columns:repeat(4,minmax(160px,1fr));
  width:100%;gap:10px!important}
.sov-rim-field,.sov-rim-lock-note,.sov-rim-scenario-reason{min-width:180px;flex:1}
.sov-rim-upload{width:100%;max-width:720px}
.sov-rim-question{width:100%;padding:12px;border:1px solid var(--warn);
  border-radius:8px;background:color-mix(in srgb,var(--warn) 8%,var(--bg-panel))}
.sov-rim-dialog__log{width:100%;max-height:340px;overflow:auto;gap:8px!important}
.sov-rim-dialog__message{max-width:82%;padding:9px 11px;border-radius:8px;
  white-space:pre-wrap}
.sov-rim-dialog__message--user{align-self:flex-end;background:var(--accent);color:white}
.sov-rim-dialog__message--assistant{align-self:flex-start;background:var(--bg-mod);color:var(--text)}
.sov-rim-composer__field{min-width:280px;flex:1}
.sov-rim-tabs,.sov-rim-tab-panels,.sov-rim-table{width:100%}
.sov-rim-tab-panels .q-tab-panel{padding:12px 0}
.sov-rim-table .q-table__container{border:1px solid var(--border);border-radius:8px}
.sov-rim-mapping-edit{display:grid!important;grid-template-columns:220px 1fr auto;
  width:100%;gap:10px!important;align-items:end}
.sov-rim-issue-list{width:100%;gap:8px!important}
.sov-rim-issue{width:100%;padding:10px;border:1px solid var(--border);
  border-radius:8px;background:var(--bg-mod)}
@media(max-width:900px){.sov-rim-intake__fields{grid-template-columns:repeat(2,minmax(150px,1fr))}
  .sov-rim-mapping-edit{grid-template-columns:1fr}}
@media(max-width:600px){.sov-rim-page{padding:10px}.sov-rim-intake__fields{grid-template-columns:1fr}
  .sov-rim-dialog__message{max-width:100%}.sov-rim-composer .sov-ui-button{width:100%}}
</style>
"""
...
def build_rim() -> None:
    ...
    ui.add_head_html(_RIM_PUBLIC_CSS)
