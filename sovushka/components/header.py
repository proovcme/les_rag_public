                ...
                with ui.dialog() as settings_dialog, ui.card().style(
                    ...
                    async def _load_settings():
                        ...
                        if d:
                            ...
                            set_speckle_url.set_value(speckle.get("base_url", "https://speckle.example.com"))
                            set_speckle_graphql.set_value(speckle.get("graphql_url", "https://speckle.example.com/graphql"))
