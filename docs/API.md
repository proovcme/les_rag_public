...
Заметки оператора (W16.3, та же механика): «запомни: …», «заметки», «забудь заметку N». Релевантные заметки и прошлые удачные ответы подмешиваются в контекст ответа автоматически (лексический recall, W16.1).
