...
Locia: компактный левый навигационный rail 96 px, вертикальные рабочие разделы и
одну широкую рабочую область. Три первичные поверхности сохраняют подписи,
вторичные разделы используют сокращённую типографику, поэтому навигация остаётся
читаемой и не забирает ширину чата. Палитра переведена с холодного серо-синего на
