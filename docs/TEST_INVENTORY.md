...
| `tests/test_fgis_full_update.py` | 6 | публичный каталог/Сплит-формы, полный updater, API/UI wiring и операторский progress contract: running/interrupted/idle, остаток, ETA, байты и скорость |
