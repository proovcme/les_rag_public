...
после release-bootstrap и version-contract regression текущая коллекция — **2929 тестов из 303 файлов**.
Это регрессионная коллекция, а не 2929 равноценных release-гейтов.
