...
|---|---:|---|
| `tests/test_tauri_desktop.py` (Windows startup additions) | focused | setup-button bootstrap lock, offline tokenizer startup, isolated NSIS smoke roots and exact installer deploy stamp |
