...
после двух regression-тестов release-bootstrap текущая коллекция — **2928 тестов из 303 файлов**.
Это регрессионная коллекция, а не 2928 равноценных release-гейтов.
