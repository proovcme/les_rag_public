...
> `tests/test_release_orchestrator.py` доказывает автоматический выбор soft/full,
> неизменность подготовленных candidate bytes между prepare и Legion acceptance,
