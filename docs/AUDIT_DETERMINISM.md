...
> **СТАТУС: ИСПОЛНЕНО** (2026-06-25/26) — инверсия сделана: agent-router ОСНОВНОЙ (`router_primary` ON по
> умолчанию), keyword-каскад = спящий фолбэк, ProfileResolver. **Текущая механика — [ALGO-routing.md](ALGO-routing.md).**
> Ниже — решение и история (на эти §/имена ссылается код).
