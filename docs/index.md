# Л.Е.С. — командный public-репозиторий
...
почты, приватных нормативных корпусов и секретов. При этом public должен содержать
полный публикуемый код, тесты, схемы, инструкции сборки и воспроизводимые demo-fixtures,
необходимые команде для разработки и локального запуска.
