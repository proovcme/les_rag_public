...
**✅ исправлено (437f1aa):** ALGO-smeta/object — два шаблона (wooden_house + monolith_office); ALGO-gesn — v2-слой базы; smeta_ontology.yaml «Прил.3»→«Прил.4», `smeta_ontology.md` регенерирован. В 0.24.0.12 явный smeta-режим получил детерминированное состояние параметров по истории текущей сессии, парсер понимает разговорные площадь/этажность, а неподдержанные варианты вроде свай/крыльца/плоской кровли не скрываются в расчёте, а выходят warning.
