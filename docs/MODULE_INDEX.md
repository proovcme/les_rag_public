...
| smeta/artifact | оформление длинных сметных таблиц в отдельный Markdown-artifact: извлекает уже написанные моделью ВОР/стоимость/развилки, считает видимые суммы, схлопывает длинные таблицы в чате; не выбирает работы, нормы или ставки | `smeta_artifact_service`, `chat.py` payload `artifact` | [SMETA_MECHANICS.md](SMETA_MECHANICS.md) | ✅ |
