...
```
версия продукта (SemVer):  0.24.5  (dev: рабочий GUI FGIS + clean-install RAG repair, 2026-07-15)
номер сборки:              416     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.416 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.5 / build 416 (не опубликован)
