...
```
версия продукта (SemVer):  0.24.17 (released: RAG/dataset/smeta repair, 2026-07-15)
номер сборки:              438     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.438 (внутренняя совместимость обновления)
