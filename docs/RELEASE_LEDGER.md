...
```
версия продукта (SemVer):  0.24.7  (dev: безопасное in-place обновление Windows, 2026-07-15)
номер сборки:              418     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.418 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.7 / build 418 (не опубликован)
