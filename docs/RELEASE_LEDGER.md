...
```
версия продукта (SemVer):  0.24.15 (release candidate: universal VPS patch channel, 2026-07-15)
...
следующий выпуск:          0.24.15 / build 426
...
>
> Дата: 2026-07-15
> Статус: release candidate; локальные гейты и live Legion acceptance pending.
