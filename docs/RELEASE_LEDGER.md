...
```
версия продукта (SemVer):  0.24.16 (release candidate: persistent VPS patch helper, 2026-07-15)
номер сборки:              427     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.427 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.16 / build 427
