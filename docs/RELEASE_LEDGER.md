...
```
версия продукта (SemVer):  0.24.21 (dev: chat UX, 2026-07-16)
номер сборки:              442     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.442 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.21 / build 442 — release candidate
...
>
> Дата: 2026-07-16
> Статус: release candidate. В Совушке появилась кнопка «Остановить диалог»: она отменяет
...
> workflow не продолжает выбирать нормы и считать ЛСР. Добавлены регрессии UI и model-workflow.
