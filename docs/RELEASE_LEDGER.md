...
```
версия продукта (SemVer):  0.24.6  (dev: безопасное in-place обновление Windows, 2026-07-15)
номер сборки:              417     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.417 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.6 / build 417 (не опубликован)
