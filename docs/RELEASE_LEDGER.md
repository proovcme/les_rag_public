...
```
версия продукта (SemVer):  0.24.15 (released: universal VPS patch channel, 2026-07-15)
номер сборки:              426     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.426 (внутренняя совместимость обновления)
ветка выпуска:             main (сведение веток выполняется перед публикацией)
dev HEAD:                  HEAD  (см. git log -1)
задеплоено на рантайм:     0.24.15 / build 426 (live on Legion, 2026-07-15)
Windows-выпуск:            0.24.15 / build 426 (public GitHub release)
...
>
> Дата: 2026-07-15
> Статус: released; локальные, изолированные Windows и live Legion gates пройдены.
> Один последний полный установочный выпуск доставляет обновлятор всем Windows-пользователям.
> Начиная с совместимой 0.24.15 GUI получает ограниченные патчи из `https://les.ovc.me/updates/`:
