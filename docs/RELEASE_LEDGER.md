...
```
версия продукта (SemVer):  0.24.13 (dev: truthful readiness + service datasets, 2026-07-15)
номер сборки:              424     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.424 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.13 / build 424 (Python/UI patch; Legion gate pending)
