...
```
версия продукта (SemVer):  0.24.9  (dev: тяжёлые project PDF + рабочая интеграция Л.И.С.Т., 2026-07-15)
номер сборки:              420     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.420 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.9 / build 420 (Mac gate green; Legion gate/publish pending)
