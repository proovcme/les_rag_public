...
```
версия продукта (SemVer):  0.24.4  (dev: FGIS progress + lexical migration, 2026-07-15)
номер сборки:              415     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.415 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.4 / build 415 (не опубликован)
