...
```
версия продукта (SemVer):  0.24.8  (dev: однозначный операторский статус датасетов, 2026-07-15)
номер сборки:              419     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.419 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.8 / build 419 (не опубликован)
...
>
> Дата: 2026-07-15
> Статус: release candidate после визуальной live-проверки build 418 на Legion.
