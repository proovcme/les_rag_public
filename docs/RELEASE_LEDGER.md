...
номер сборки:              407     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.407 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.1 / build 407 после полного Windows gate
рантайм /api/version:      проверяется отдельно; dev-правка не считается развёртыванием
```

> 0.24.1 / build 407 — единый контракт версии, закреплённый программный контур и автоматический patch-release
>
> Дата: 2026-07-14
...
> Аудит 2926 pytest отделил 288 тестов feature-off Unified/Construction Harness и 49 агрегатных
