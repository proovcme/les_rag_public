...
номер сборки:              410     (отдельно от версии продукта)
версия Tauri/NSIS:         5.1.410 (внутренняя совместимость обновления)
...
следующий выпуск:          0.24.1 / build 410 после полного Windows gate
