...
Дата среза: 2026-07-14. Версия дерева: подготовка `0.24.1`, сборка `409`.
...
229.33 s**; текущий собираемый размер профиля — **2643**. Он пока включает
49 старых повторов из смешанных файлов, потому что их нельзя исключить целым файлом без потери
96 полезных проверок. После переноса полезных тестов ожидаемый чистый размер — 2594.
