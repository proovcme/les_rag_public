...
- ⚠️ **В корпусе НЕТ настоящих КС-2/ЛС(смета):** только ВОР (1901+2101), ИД (сканы+доки) и 1 акт приёмки .docx. Классический ВОР↔КС-2 mismatch не из чего собрать — нужен реальный КС-2/ЛС от пользователя. Движок сверки + чат-канал готовы и доказаны вживую на 2 источниках.
