...
- **Полировка (мелочь):** ярлыки источников = сырые имена датасетов (`*_Index`); в пробелах мелькают строки-заголовки секций и числовой мусор парсинга ВОР. Реальная сверка по одинаковому scope нужна fuzzy-match наименований (ВОР «Кабель медный ППГнг 3х1,5» ≠ ИД «Кабель 3х1,5 в гофре ВВГнг» — это РАЗНЫЕ кабели, сверка верно даёт gap).
