...
### История тестовой архитектуры

| Прежний путь | Почему в архиве | Текущая замена |
|---|---|---|
| `docs/TEST_INVENTORY.md` (снимок до 2026-08-30) | 424 строки релизной хронологии и устаревших счётчиков смешивали текущие и legacy-профили | `docs/TEST_INVENTORY.md`, `Makefile` |

Исторический снимок сохранён как `TEST_INVENTORY_HISTORY_2026-08-30.md`.
