...
DOC_TYPES = {
    ...
    "ACT_GENERAL":   "Акт выполненных работ / сверки / приёма-передачи",
    "CONTRACT":      "Договор / Контракт / Соглашение",
    "ADDENDUM":      "Дополнительное соглашение / Приложение к договору",
    "INVOICE_BILL":  "Счёт на оплату / Счёт-фактура / УПД",
    "TZ_TOR":        "Техническое задание / Задание на проектирование (ТЗ)",
    "LETTER":        "Письмо / Официальное обращение / Протокол",
    "PASSPORT_CERT": "Паспорт оборудования / Сертификат / Руководство",
    "DRAWING":       "Чертежи / Схемы / Графическая часть",
...
DOC_TYPE_HINTS = {
    ...
    "ACT_GENERAL":   ["акт выполненных", "акт приема", "акт приёма", "акт оказания", "акт сверки", "акт передачи"],
    "CONTRACT":      ["договор", "контракт", "соглашение", "подрядчик", "заказчик"],
    "ADDENDUM":      ["дополнительное соглашение", "доп. соглашение", "приложение №", "приложение к договору"],
    "INVOICE_BILL":  ["счет на оплату", "счёт на оплату", "счет-фактура", "упд", "передаточный"],
    "TZ_TOR":        ["техническое задание", "техзадание", "тз", "задание на проектирование"],
    "LETTER":        ["письмо", "протокол", "обращение", "уведомление"],
    "PASSPORT_CERT": ["паспорт", "сертификат", "руководство", "формуляр"],
    "DRAWING":       ["чертеж", "чертёж", "схема", "план", "разрез"],
