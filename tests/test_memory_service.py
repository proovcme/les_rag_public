...
def test_autonote_ignores_questions_and_commands():
    for q in [
        ...
        # em-dash «—» раньше ложно считался маркером факта при команде «выгрузи»
        "выгрузи полную таблицу позиций с листа 1: №, наименование, арт, ед, кол-во, цена, сумма — без пропусков",
    ]:
