...
SMETA_DOCUMENT_TESTS ?= tests/test_smeta_chat_application_service.py tests/test_ks_forms_service.py tests/test_rim_coverage_header.py tests/test_forms_templates.py tests/test_command_service.py tests/test_smeta_workbook_tools.py tests/test_chat_profile_service.py tests/test_chat_profile_runtime.py
...
UPDATER_TESTS ?= tests/test_vps_patch.py tests/test_windows_application_update.py tests/test_windows_update_shell.py tests/test_update_service.py tests/test_manual_update_ui.py tests/test_mac_update.py
