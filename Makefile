...
UNIT_TESTS ?= tests/test_answer_contract_service.py tests/test_architecture_contract_gate.py tests/test_candidate_selection_service.py tests/test_evidence_contract.py tests/test_numeric_provenance.py tests/test_publication_check.py tests/test_query_router.py tests/test_smeta_resource_normalizer.py
