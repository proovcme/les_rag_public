...
| **С.О.В.У.Ш.К.А.** | Система Обработки и Выдачи: Умная, Шаблонизированная, Классифицированная, Автоматизированная | UI на NiceGUI (порт 8051) | ✅ v4.0 |
...
│   └── bge-m3:latest
│
└── С.О.В.У.Ш.К.А. (NiceGUI, порт 8051) — UI v4.0
...
├── sovushka_ng.py            # NiceGUI UI v4.0 (2129 строк)
...
| С.О.В.У.Ш.К.А. v4.0 (NiceGUI) | 8 | 7 | 1 | 0 | 87% |
