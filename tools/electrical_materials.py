#!/usr/bin/env python3
"""CLI lever for electrical material/equipment manifests."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a read-only electrical material manifest from a VOR/SO PDF.")
    ...
    manifest = extract_electrical_material_manifest(
        args.pdf,
